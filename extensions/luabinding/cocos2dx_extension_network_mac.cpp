...
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extension_network_mac_CCHttpRequest_getIsInProgress00
static int tolua_cocos2dx_extension_network_mac_CCHttpRequest_getIsInProgress00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extension_network_mac_CCHttpRequest_getResponseData00
static int tolua_cocos2dx_extension_network_mac_CCHttpRequest_getResponseData00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extension_network_mac_CCNetwork_httpRequestLua00
static int tolua_cocos2dx_extension_network_mac_CCNetwork_httpRequestLua00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
TOLUA_API int tolua_cocos2dx_extension_network_mac_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"CCHttpRequest");
   ...
   tolua_function(tolua_S,"getIsInProgress",tolua_cocos2dx_extension_network_mac_CCHttpRequest_getIsInProgress00);
   ...
   tolua_function(tolua_S,"getResponseData",tolua_cocos2dx_extension_network_mac_CCHttpRequest_getResponseData00);
  ...
  tolua_beginmodule(tolua_S,"CCNetwork");
   tolua_function(tolua_S,"httpRequestLua",tolua_cocos2dx_extension_network_mac_CCNetwork_httpRequestLua00);
  tolua_endmodule(tolua_S);
 tolua_endmodule(tolua_S);
 return 1;
}
