...
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extension_crypto_win32_CCCrypto_encodeBase64Lua00
static int tolua_cocos2dx_extension_crypto_win32_CCCrypto_encodeBase64Lua00(lua_State* tolua_S)
{
...
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extension_crypto_win32_CCCrypto_decodeBase64Lua00
static int tolua_cocos2dx_extension_crypto_win32_CCCrypto_decodeBase64Lua00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extension_crypto_win32_CCCrypto_MD5Lua00
static int tolua_cocos2dx_extension_crypto_win32_CCCrypto_MD5Lua00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* Open function */
TOLUA_API int tolua_cocos2dx_extension_crypto_win32_open (lua_State* tolua_S)
{
 tolua_open(tolua_S);
 ...
 TOLUA_API int luaopen_cocos2dx_extension_crypto_win32 (lua_State* tolua_S) {
 return tolua_cocos2dx_extension_crypto_win32_open(tolua_S);
};
#endif
